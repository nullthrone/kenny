...
screenshots — and ADR-0026 established kenny's data-minimization stance for exactly
...
- **Per-user session minutes.** Rejected: names the child on the wire and in the
  store; ADR-0026 deliberately avoided per-user attribution even where technically
