# 0021. Orchestrate Windows Quick Assist as a concierge via user-session launch
...
- Bad / trade-offs: the tray is now load-bearing for one more capability — if it is not
  ...
  else. The shared-catalog safety guard ([ADR-0019](0019-agent-side-deterministic-tool-guard.md))
