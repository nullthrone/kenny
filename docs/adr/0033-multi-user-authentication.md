# 0033. Multi-user authentication: accounts, roles, sessions, and per-user access tokens

- Status: accepted
- Amended by: [ADR-0037](0037-oauth2-authorization-server-for-mcp.md),
  [ADR-0038](0038-explicit-per-call-agent-targeting.md),
  [ADR-0047](0047-capability-profiles.md)
- Date: 2026-07-04
