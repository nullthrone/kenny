# 0056. Serialize this process's SQLite writers behind an in-process lock

- Status: proposed
- Date: 2026-08-05
- Amends: [ADR-0007](0007-telemetry-push-model-and-sqlite-storage.md)
- Touches: [ADR-0043](0043-server-database-backup-and-restore.md)
...
can be lost, and only on an OS/host crash, never a process crash. [ADR-0043](0043-server-database-backup-and-restore.md)'s
...
- Bad: `synchronous=NORMAL` accepts loss of the most recent commit(s) on an OS/host crash.
  ...
  ([ADR-0043](0043-server-database-backup-and-restore.md)), not acceptable to apply silently
