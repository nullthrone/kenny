...
import type { Pat, ProfileMe } from './types'
...
type OpenModal = 'edit' | 'password' | 'totp' | 'pats' | null
          ...
          {me.data.is_shared_token ? (
            ...
            <>
              ...
              <div className={styles.sessions}>
                <div className={styles.sessionsTitle}>SESSION</div>
                <p className={styles.sessionsBody}>
                  Changing your password or disabling two-factor signs out every other session automatically. To end just this
                  one, log out below.
                </p>
